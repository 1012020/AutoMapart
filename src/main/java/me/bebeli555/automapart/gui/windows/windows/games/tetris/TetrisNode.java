...
public class TetrisNode {
	...
	public boolean canMoveRight() {
		for (int i = 0; i < this.familyNodes.size(); i++) {
			...
			if (this.familyNodes.get(i).getX() > TetrisGameWindow.toX - 20) {
				return false;
			}	
		}
		return true;
	...
	public boolean canMoveLeft() {
		for (int i = 0; i < this.familyNodes.size(); i++) {
			...
			if (this.familyNodes.get(i).getX() < TetrisGameWindow.fromX + 10) {
				return false;
			}	
		}
		return true;
	...
	public boolean canGoDown() {		
		for (int i = 0; i < this.familyNodes.size(); i++) {
			...
			if (this.familyNodes.get(i).getY() > TetrisGameWindow.toY - 10) {
				return false;
			}
	...
	public void rotate() {
		...
		if (rot.equals("I")) {
			...
			if(x+20 > TetrisGameWindow.toX)x-=20;
			if(x-10 < TetrisGameWindow.fromX)x+=10;
			if (rotation == 1) {
		...
		if (rot.equals("S")) {
			...
			if(x+20 > TetrisGameWindow.toX)x-=10;
			if (rotation == 1) {
				this.familyNodes.add(new TetrisNode(x + 10, y));
				this.familyNodes.add(new TetrisNode(x, y + 10));
		...
		if (rot.equals("T")) {
			...
			if (rotation == 1) {
				if(x+10 > TetrisGameWindow.toX)x-=10;
				if(x-10 < TetrisGameWindow.fromX)x+=10;
				this.familyNodes.add(new TetrisNode(x + 10, y));
				this.familyNodes.add(new TetrisNode(x - 10, y));
				this.familyNodes.add(new TetrisNode(x, y + 10));
